    ...
    <KoryoLayout subtitle="ご利用にあたって">
      <div className={styles.card}>
        ...
        <Section title="第６条　個人情報の利用停止等">
          <ol className={styles.orderedList}>
            <li>当委員会は、ユーザーが不正の手段により他クラスのログイン情報を取得した恐れがある場合には、必要な調査を行う。</li>
            <li>前項の調査結果に基づき、不正な手段による情報取得が認定されたと判断した場合には、遅滞なく当該クラスのログイン情報の変更や利用停止等のセキュリティ保護を目的とする措置を行う。</li>
            <li>当委員会は、前項の規定に基づき措置を行った場合には、遅滞なく、これを該当クラスに所属するユーザーに通知する。</li>
